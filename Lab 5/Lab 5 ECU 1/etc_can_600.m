function msg = etc_can_600(msg_name)
...
%%
  ...
  msg.fields{1}.name          = 'DutyCycle';
  msg.fields{1}.units         = 'PWM%';
...
%   msg.fields{2}.name          = 
%   msg.fields{2}.units         = 
%   msg.fields{2}.start_bit     = 
%   msg.fields{2}.bit_length    = 
%   msg.fields{2}.byte_order    = 
%   msg.fields{2}.data_type     = 
