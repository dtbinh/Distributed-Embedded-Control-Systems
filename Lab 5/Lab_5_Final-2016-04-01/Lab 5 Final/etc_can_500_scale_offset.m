function msg = etc_can_500(msg_name)
...
%%
  ...
  msg.name                    = 'etc_can_500'
  msg.description             = 'etc_can_500 for transmission'
  msg.protocol                = 'MotoHawk'
  msg.module                  = 'PCM-1'
  msg.channel                 = 1
